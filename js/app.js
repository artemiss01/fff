(() => {
  ...
  const i = { inputMaskModule: null, selectModule: null };
  let n = {
    getErrors(e) {
      let t = 0,
    ...
    document.addEventListener("click", function (e) {
      ((o = e.target),
        (function () {
          if (t.any())
            if (
              o.classList.contains("menu__link_arrow") &&
              o.closest(".menu__item")
            )
              o.closest(".menu__item").classList.toggle("sub-menu-active");
            else {
